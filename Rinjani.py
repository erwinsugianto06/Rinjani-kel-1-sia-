...
st.write()
if Jumlah ==3: potongan = (Jumlah*Harga)*7/100 elif Jumlah >3: potongan = (Jumlah*Harga)*10/100 else : potongan =0
...
while choice :
    ...
    if choice=="Mobile Banking":
        st.info("Apabila anda melakukan pembayaran dengan Mobile Banking harap upload bukti pembayaran di bawah ini. (BCA NO.REK : 8035200211).")
        break
garis()  
